...
# --------------------------------------------Binary Relevance-----------------------------------------------------
# Fitting a Multinomial Naive Bayes model with Binary Relevance problem transformation method and get training accuracy
br_predictions_train, br_predictions_train_prob, br_accuracy_train, br_classifier, \
    ...
    model_fitting_and_get_training_accuracy(MultinomialNB, BinaryRelevance, train_tf_idf, y_train)

print('Binary Relevance Starts')

print('Accuracy on Training Data of Multinomial Naive Bayes with Binary Relevance: '
      '{br_accuracy_train}'.format(br_accuracy_train=br_accuracy_train))

print('Accuracy for each label on Training Data of Multinomial Naive Bayes with Binary Relevance: '
...
print('Accuracy on Test Data of Multinomial Naive Bayes with Binary Relevance: '
      '{br_accuracy_test}'.format(br_accuracy_test=br_accuracy_test))

print('Accuracy for each label on Test Data of Multinomial Naive Bayes with Binary Relevance: '
...
# Fitting a Multinomial Naive Bayes model with Classifier Chain problem transformation method and get training accuracy
cc_predictions_train, cc_predictions_train_prob, cc_accuracy_train, cc_classifier, \
    ...
    model_fitting_and_get_training_accuracy(MultinomialNB, ClassifierChain, train_tf_idf, y_train)

print('Classifier Chain Starts')

print('Accuracy on Training Data of Multinomial Naive Bayes with Classifier Chain: '
      '{cc_accuracy_train}'.format(cc_accuracy_train=cc_accuracy_train))

print('Accuracy for each label on Training Data of Multinomial Naive Bayes with Classifier Chain: '
...
print('Accuracy on Test Data of Multinomial Naive Bayes with Classifier Chain: '
      '{cc_accuracy_test}'.format(cc_accuracy_test=cc_accuracy_test))

print('Accuracy for each label on Test Data of Multinomial Naive Bayes with Classifier Chain: '
...
# Fitting a Multinomial Naive Bayes model with Label Power Set problem transformation method and get training accuracy
lp_predictions_train, lp_predictions_train_prob, lp_accuracy_train, lp_classifier, \
    ...
    model_fitting_and_get_training_accuracy(MultinomialNB, LabelPowerset, train_tf_idf, y_train)

print('Label Power Set Starts')

print('Accuracy on Training Data of Multinomial Naive Bayes with Label Power Set: '
      '{lp_accuracy_train}'.format(lp_accuracy_train=lp_accuracy_train))

print('Accuracy for each label on Training Data of Multinomial Naive Bayes with Label Power Set: '
...
print('Accuracy on Test Data of Multinomial Naive Bayes with Label Power Set: '
      '{lp_accuracy_test}'.format(lp_accuracy_test=lp_accuracy_test))

print('Accuracy for each label on Test Data of Multinomial Naive Bayes with Label Power Set: '
